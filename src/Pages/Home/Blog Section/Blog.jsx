            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4 lg:p-0 lg:px-10'>
                ...
                <div className="flex flex-col gap-4 w-full">
                    <div className="skeleton w-full flex-grow">
                        <img className='rounded-lg' src="https://ceoworld.biz/wp-content/uploads/2024/04/Adventure-Tourism.jpg" alt="" />
                    </div>
                ...
                <div className="flex flex-col gap-4 w-full">
                    <div className="skeleton w-full flex-grow">
                        <img className='h-full rounded-lg' src="https://static.wanderon.in/wp-content/uploads/2024/10/street-foods-in-india.jpg" alt="" />
                    </div>
                ...
                <div className="flex flex-col gap-4 w-full">
                    <div className="skeleton w-full flex-grow">
                        <img className='rounded-lg' src="https://www.muchbetteradventures.com/magazine/content/images/size/w2000/2020/01/02173546/GettyImages-1155613712-1.jpg" alt="" />
                    </div>
