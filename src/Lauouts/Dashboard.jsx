        ...
        <>
            <div className="flex flex-col lg:flex-row min-h-screen">
                ...
                <motion.div
                    ...
                    className="w-full lg:w-1/5 md:min-h-screen bg-slate-800 p-4 lg:p-8 lg:fixed">
            ...
            <footer className="footer footer-center bg-base-300 text-base-content p-4">
                <aside>
                    <p>Copyright © {new Date().getFullYear()} - All right reserved by JourneySync</p>
                </aside>
            </footer>
        </>
    );
